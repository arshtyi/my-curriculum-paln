...
#table(
    ...
    [sd02810880], [马克思主义基本原理<C>], $3$, $4$,
    [sd02810860], [中国近现代史纲要<C>], $3$, $1$,
    [sd02810850], [思想道德与法治<C>], $3$, $1$,
    [sd03119A82], [新工科综合英语（1）<S>], $2$, $1$,
    [sd03119A72], [新工科综合英语（2）<S>], $2$, $2$,
    [sd03119BC2], [科技英语文献阅读与翻译<C>], $2$, $3/4$,
    [sd03119BB2], [英语演讲与辩论<C>], $2$, $3/4$,
    ...
    [sd02910630], [体育（1）<C>], $1$, $1$,
    [sd02910640], [体育（2）<C>], $1$, $1$,
    [sd02910650], [体育（3）<C>], $1$, $1$,
    [sd02910660], [体育（4）<C>], $1$, $1$,
    [sd06910010], [军事理论<C>], $2$, $2$,
    [sd090101C0], [形势与政策（1）<C>], $0$, $1$,
    [sd090101D0], [形势与政策（2）<C>], $0.5$, $2$,
    [sd090101E0], [形势与政策（3）<C>], $0$, $3$,
    [sd090101F0], [形势与政策（4）<C>], $0.5$, $4$,
    [sd09010200], [形势与政策（5）<P>], $0$, $5$,
    ...
    [sd30210010], [高等数学（1）<C>], $5$, $1$,
    [sd302203B0], [线性代数<C>], $3$, $1$,
    [sd01326350], [程序设计基础<C>], $3$, $1$,
    [sd01336390], [计算概论<C>], $2$, $1$,
    [sd30220010], [高等数学（2）<C>], $5$, $2$,
    [sd99320020], [大学物理<C>], $3$, $2$,
    [sd99320000], [大学物理实验I<C>], $1$, $2$,
    [sd994202C0], [工程实践创新训练<C>], $1$, $2$,
    [sd01336360], [人工智能引论<C>], $3$, $2$,
    [sd01336370], [高级语言程序设计<C>], $3$, $2$,
    ...
    [sd01336420], [计算机网络<C>], $3$, $3$,
    [sd01336560], [计算机组成与系统结构<C>], $4$, $4$,
    [sd01331930], [操作系统<C>], $4$, $4$,
    ...
    [sd01332150], [认知科学与类脑计算<P>], $3$, $5$,
    [sd01332100], [神经网络与深度学习<P>], $3$, $5$,
    [sd01331450], [计算机图形学<P>], $3$, $5$,
    [sd01332080], [信息检索与数据挖掘<P>], $3$, $5$,
    [sd01332070], [人工智能应用实践<P>], $3$, $5$,
    ...
    [sd01331410], [汇编语言<P>], $3$, $5$,
    [sd013365E0], [并行计算<P>], $3$, $5$,
    [sd01331960], [大数据管理与分析<P>], $3$, $5$,
    [sd01332010], [计算理论<P>], $3$, $5$,
    [sd01331980], [可视化技术<P>], $3$, $5$,
    [sd01332220], [机器人工程实践<P>], $3$, $5$,
    [sd01331160], [数字图像处理<P>], $3$, $5$,
